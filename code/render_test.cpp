...
InitTestScene(test_scene *Scene, v2i ScreenResolution, memory_region *Region, render_memory_op_queue *Queue)
{
	...
	Scene->Smile = LoadPNG(Region, Queue, ConstZ("w:\\cardcade\\data\\Textures\\smile.png"), NextTextureHandle++);
	Scene->Sword = LoadPNG(Region, Queue, ConstZ("w:\\cardcade\\data\\Textures\\sword_icon.png"), NextTextureHandle++);
	Scene->Heart = LoadPNG(Region, Queue, ConstZ("w:\\cardcade\\data\\Textures\\heart_icon.png"), NextTextureHandle++);
