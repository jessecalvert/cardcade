...
* Last modified: December 6, 2018, 17:31
*/
...
enum interaction_type
{
	...
	UI_Interaction_SelectAbility,
	UI_Interaction_PassTurn,
...
struct ui_state
{
	...
	entity_id HoveredID;
	u32 HoveredAbilityIndex;

	entity_id SelectedID;
	u32 SelectedAbilityIndex;
	u32 TargetCount;
	entity_id TargetIDs[MAX_TARGETS];
