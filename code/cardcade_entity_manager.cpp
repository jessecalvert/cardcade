/*@H
* File: cardcade_entity_manager.cpp
* Author: Jesse Calvert
* Created: November 5, 2018, 13:59
* Last modified: December 17, 2018, 14:51
*/
...
internal void
AddPieceEntityInfo(entity *Entity, v2 Scale, quaternion Rotation, v3 Offset, surface_material Material)
{
	AddPiece(Entity, V3(Scale.x, Scale.y, 0), Rotation, Offset, PieceType_EntityInfo, {0}, {0}, Material);
}
...
internal void
InitEntityManager(game_mode_battle *BattleMode, entity_manager *EntityManager, memory_region *Region, assets *Assets)
{
