...
* Last modified: December 17, 2018, 16:43
*/
			...
			++AssetIndex)
		{
			...
			switch(AssetHeader->Type)
			{
				...
				case AssetType_EntityInfo:
				{
					...
					TabPrintf(&Layout, "AbilityCount : %d", EntityInfo->AbilityCount);
					TabPrintf(&Layout, "PieceCount : %d", EntityInfo->PieceCount);
					TabPrintf(&Layout, "Attack : %d", EntityInfo->Attack);
					TabPrintf(&Layout, "MaxDefense : %d", EntityInfo->MaxDefense);
					TabPrintf(&Layout, "Influence : %d", EntityInfo->Influence);
					TabPrintf(&Layout, "VictoryPoints : %d", EntityInfo->VictoryPoints);
