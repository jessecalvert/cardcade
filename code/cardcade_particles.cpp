/*@H
* File: cardcade_particles.cpp
* Author: Jesse Calvert
* Created: June 14, 2018, 17:51
* Last modified: November 6, 2018, 18:16
*/
		...
		++ParticleIndex_4)
	{
		...
		if(AnyTrue(A->Color.a > ZeroF32_4x()))
		{
				...
				++LaneIndex)
			{
				...
				if(Color.a > 0.0f)
				{
					PushUprightTexture(RenderGroup, P, Emitter->Dim, Emitter->BitmapID, Emitter->Roughness, Emitter->Metalness, Color);
				}
			}
		}
	}
