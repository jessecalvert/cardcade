...
* Last modified: December 17, 2018, 17:09
*/

#include "cardcade.h"

#include "cardcade_renderer.cpp"
#include "cardcade_assets.cpp"
#include "cardcade_asset_rendering.cpp"
#include "cardcade_aabb.cpp"
#include "cardcade_convex_hull.cpp"
#include "cardcade_gjk.cpp"
#include "cardcade_rigid_body.cpp"
#include "cardcade_animation.cpp"
#include "cardcade_particles.cpp"
#include "cardcade_ui.cpp"
#include "cardcade_entity_manager.cpp"
#include "cardcade_ability.cpp"
#include "cardcade_battle_mode.cpp"
#include "cardcade_title_screen.cpp"
#include "cardcade_editor.cpp"
...
extern "C" GAME_UPDATE_AND_RENDER(GameUpdateAndRender)
{
	...
	{
		case GameMode_BattleMode:
		{
			UpdateAndRenderBattleMode(GameState, GameState->BattleMode, RenderCommands, Input);
		} break;
	...
	{
		if(GameState->CurrentMode == GameMode_BattleMode)
		{
			UpdateAndRenderEditor(GameState, GameState->Editor, &GameState->UI, GameState->BattleMode, Input);
		}
	}
